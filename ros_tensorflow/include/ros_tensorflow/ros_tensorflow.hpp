...
public:
  ...
  *
  * Class constructor, which creates a new TensorFlow session from a frozen graph file.
  * Input and output operations must be identified by the user.
  * \param graph_filename             File name of the frozen graph
  * \param input_operation_name       Entry operation name within the graph
  * \param input_operation_name       Exit operation name within the graph
  */
  ...
  *
  * Adds a new input vector to the TensorFlow session, for use in inference.
  * \param input_data                 Input data vector
  * \param input_dimensions           Dimensions of input vector data
  ...
  * \brief RunInference
  *
  * Runs inference on the input vectors.
  * \return                           Status of the function (success or failure)
  */
  ...
  *
  * Retrieves the results of inference.
  ...
  * \param output_vectors             Vector of vectors for storing output result data
  */
